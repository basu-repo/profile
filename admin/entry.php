...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!admin_verify_csrf($_POST['csrf_token'] ?? null)) {
        ...
        redirect($entryId > 0 ? 'entry.php?id=' . $entryId : 'entry.php');
    }
...
$isNew = $entryId === 0;
admin_render_header($isNew ? 'New Research Entry' : 'Edit Research Entry', 'research');
?>
<div class="contact-form">
    ...
    <form method="post" class="admin-content-form">
        ...
        <div class="admin-section-actions">
            ...
            <a class="btn admin-btn-secondary" href="entries.php">Cancel</a>
        </div>
    </form>
</div>
<?php
