 ...
 *
 * The rich-text editor is only pulled in by the two screens that actually
 * edit prose. The header records that choice so the footer emits the matching
        ...
        <div class="container">
            ...
            <?php if ($user): ?>
                <ul class="nav-menu">
                    ...
                    <li><a href="/admin/entries" class="<?= $active === 'research' ? 'active' : '' ?>">Research</a></li>
