        ...
        <div class="hero-content">
            <div class="hero-image-container">
                <div class="profile-image-wrapper">
                    <img src="<?= h(asset_url(site_content_get('profile_image'))) ?>" alt="<?= h(site_content_get('site_name')) ?>" class="profile-image">
                </div>
            </div>
