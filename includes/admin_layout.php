...
function admin_render_header(string $title, string $active = ''): void
{
    ...
    $user = admin_user();
    $loadQuill = in_array($active, ['content', 'research'], true);
    ?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="container">
            ...
            <?php if ($user): ?>
                <ul class="nav-menu">
                    ...
                    <li><a href="messages.php" class="<?= $active === 'messages' ? 'active' : '' ?>">Messages</a></li>
                    <li><a href="entries.php" class="<?= $active === 'research' ? 'active' : '' ?>">Research</a></li>
                    <li><a href="content.php" class="<?= $active === 'content' ? 'active' : '' ?>">Content</a></li>
                    <li><a href="../index.php" target="_blank" rel="noopener noreferrer">View Site</a></li>
                    <li><a href="logout.php">Logout</a></li>
                </ul>
            <?php elseif (admin_count_users() === 0): ?>
                <ul class="nav-menu">
                    <li><a href="setup.php" class="<?= $active === 'setup' ? 'active' : '' ?>">Register</a></li>
                </ul>
            <?php else: ?>
                <ul class="nav-menu">
...
function admin_render_footer(): void
{
    ...
    $loadQuill = in_array($scriptName, ['content.php', 'entry.php'], true);
    ?>
        </div>
    </section>
    <?php if ($loadQuill): ?>
