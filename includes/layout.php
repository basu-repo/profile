...
/**
 * Shared chrome for the research pages, matching the markup and classes the
 * rest of the site already uses (navbar / page-content / footer in
 * css/styles.css). The legacy pages each still carry their own copy; they can
 * move onto this whenever they are next touched.
 */
